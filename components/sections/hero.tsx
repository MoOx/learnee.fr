...
export function Hero() {
  const titleText = "Stratégie pédagogique & design d'expérience learning";
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-20 md:py-32 md:pb-4 pb-4 pt-4 md:pt-32">
        <div className="max-w-4xl">
          <p className="text-muted-foreground mb-6 text-lg font-normal">
            Je suis Hélène Perez, fondatrice de Learnee
          </p>
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-[96px] font-semibold tracking-tight leading-[1] text-balance md:text-9xl">
            {words.map((word, index) => (
              <span
                key={index}
                className={`hero-word my-0 py-2 font-mono font-normal text-5xl md:text-7xl ${word === "learning" ? "ai-gradient-word" : ""}`}
                style={{
          ...
          <p className="mt-8 max-w-xl leading-relaxed text-left text-lg text-zinc-500 ml-0">
            Ingénieure en sciences cognitives, j'accompagne les organisations
            dans leur stratégie d'innovation pédagogique. Spécialiste du
            Learning Experience Design (LXD), je conçois des expériences
            d'apprentissage engageantes et efficaces, centrées sur l'humain.
          </p>
